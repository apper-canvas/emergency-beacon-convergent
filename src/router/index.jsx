...
const routes = [
  {
    ...
    children: [
      ...
      // Main app routes with layout
      {
        ...
        element: <Layout />,
        children: [
          createRoute({ index: true, element: <AlertPage /> }),
          createRoute({ path: "active", element: <ActivePage /> }),
          createRoute({ path: "facilities", element: <FacilitiesPage /> }),
          createRoute({ path: "history", element: <HistoryPage /> }),
