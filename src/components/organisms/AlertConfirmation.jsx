...
const elapsed = Math.floor((Date.now() - new Date(incident.CreatedOn)) / 1000)
  ...
  return (
    ...
    <div className="text-center mb-6">
        ...
        <h2 className="text-2xl font-bold text-gray-900 mb-2">Emergency Alert Sent
                    </h2>
        <p className="text-gray-600">Your emergency alert has been successfully submitted and emergency services have been notified.
                    </p>
    </div>
...
<div className="p-4 bg-blue-50 rounded-xl text-center">
                ...
                <div className="bg-red-50 border border-red-200 rounded-xl p-4">
                    <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1 space-y-2">
                            ...
                            {incident.description_c && <div className="mt-3 p-3 bg-white rounded-lg border border-red-200">
                                <p className="text-sm text-red-700 italic">"{incident.description_c}"
                                                      </p>
                            </div>}
                        </div>
                    </div>
                ...
                <div className="text-center pt-4 border-t border-gray-200">
                    <p className="text-sm text-gray-500">Alert submitted at {format(new Date(incident.CreatedOn), "h:mm a 'on' MMM d, yyyy")}
                    </p>
                </div>
            </div></div></div></Card>
  )
